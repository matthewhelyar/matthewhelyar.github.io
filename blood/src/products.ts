export class Component {
	name: string;
	text: string;
	irradPossible: boolean;
	specialPossible: boolean;
	cmvPossible: boolean;
	hbsPossible: boolean;
	storageText: string;
	color: string;
	anticoagulantTextVisibility: string;
	rhPhenVisibility: string;

	constructor(name: string, text: string, irradPossible: boolean, specialPossible: boolean, cmvPossible: boolean, hbsPossible: boolean,
		storageText: string, color: string, anticoagulantTextVisibility: string, rhPhenVisibility: string) {
		this.name = name;
		this.text = text;
...
export const redCells = new Component("R", "Red Cells", true, true, true, true,
	"STORE AT 4\u00B0C \u00B1 2\u00B0C", "Red", "visible", "visible");

export const platelets = new Component("P", "Platelets", true, true, true, false,
	"STORE AT 22\u00B0C \u00B1 2\u00B0C EXTENDED LIFE<br />AGITATE GENTLY THROUGHOUT STORAGE", "Yellow", "hidden", "hidden");

export const ffp = new Component("F", "Fresh Frozen Plasma", false, false, false, false,
	"STORE FROZEN AT -25\u00B0C OR BELOW<br />TIME THAWED _______ DATE _______", "Yellow", "hidden", "hidden");

export const cryo = new Component("C", "Cryoprecipitate", false, false, false, false,
...
export const granulocytes = new Component("G", "Granulocytes", true, true, true, true,
...
class Product {
	...
	constructor(component: Component, pack: number, irr: boolean, special: boolean, availability: boolean, code: string, volume: number, shelfLife: number, text: string) {
